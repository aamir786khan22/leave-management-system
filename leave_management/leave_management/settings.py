...
# Full path to credentials.env
dotenv_path = r"C:/Users/Asus/Desktop/LMS_FINAL/credentials.env"
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "leave_management" / "templates"],  # 👈 global templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
